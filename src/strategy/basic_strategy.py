...
class BasicStrategy():
    ...
    def pick_action(self, player_hand : PlayerHand, dealer_up_card : int,  true_count : int = 0):
        #############################################################
        ######################### Surrender #########################
        #############################################################
        ...
        if player_hand.can_surrender:
            ...
            if player_hand.get_value() == 16 and player_hand.is_pair and dealer_up_card == 10: # 8,8 vs 10
                return PlayerDecision.SURRENDER
            if player_hand.get_value() == 16 and not player_hand.is_pair and dealer_up_card == 10: # 16 vs 10
                return PlayerDecision.SURRENDER
            if player_hand.get_value() == 16 and dealer_up_card == 9:
                return PlayerDecision.SURRENDER
            if player_hand.get_value() == 15 and dealer_up_card == 10:
                return PlayerDecision.SURRENDER
            if player_hand.get_value() == 14 and player_hand.is_pair() and dealer_up_card == 10: # 7,7 vs 10
                return PlayerDecision.SURRENDER
            if player_hand.get_value() == 14 and not player_hand.is_pair() and dealer_up_card == 10: # 14 vs 10
                return PlayerDecision.SURRENDER
        ...
        if player_hand.is_splittable():
            ...
            if player_hand.get_value() == 8 and 5 <= dealer_up_card <= 6:
                return PlayerDecision.SPLIT
            if player_hand.get_value() == 12 and player_hand == [6,6] and 2 <= dealer_up_card <= 6:
                return PlayerDecision.SPLIT
            ...
            if player_hand.get_value() == 18 and 2 <= dealer_up_card <= 9 and dealer_up_card != 7:
                return PlayerDecision.SPLIT
            if player_hand.get_value() == 12 and player_hand == [11,11] and 2 <= dealer_up_card <= 10:
                return PlayerDecision.SPLIT
        ...
        if player_hand.is_soft():
            ...
            if player_hand.get_value() >= 19:
                return PlayerDecision.STAND
            if player_hand.get_value() == 18 and 3 <= dealer_up_card <= 6 and player_hand.can_double:
                return PlayerDecision.DOUBLE
            if player_hand.get_value() == 18 and 3 <= dealer_up_card <= 6 and not player_hand.can_double:
                return PlayerDecision.STAND
            if player_hand.get_value() == 17 and 3 <= dealer_up_card <= 6 and player_hand.can_double:
                return PlayerDecision.DOUBLE
            if player_hand.get_value() == 16 and 3 <= dealer_up_card <= 6 and player_hand.can_double:
                return PlayerDecision.DOUBLE
            if player_hand.get_value() == 15 and 4 <= dealer_up_card <= 6 and player_hand.can_double:
                return PlayerDecision.DOUBLE
            if player_hand.get_value() == 14 and 4 <= dealer_up_card <= 6 and player_hand.can_double:
                return PlayerDecision.DOUBLE     
            if player_hand.get_value() == 13 and 5 <= dealer_up_card <= 6 and player_hand.can_double:
                return PlayerDecision.DOUBLE
            if player_hand.get_value() == 12 and 5 <= dealer_up_card <= 6 and player_hand.can_double:
                return PlayerDecision.DOUBLE      
            else:
        ...
        ####################### Hard Doubles ########################
        #############################################################
        logger.info(player_hand.can_double)
        if player_hand.can_double:
            ...
            if player_hand.get_value() == 10 and 2 <= dealer_up_card <= 9:
                return PlayerDecision.DOUBLE
            if player_hand.get_value() == 9 and 7 <= dealer_up_card <= 9:
                return PlayerDecision.DOUBLE
